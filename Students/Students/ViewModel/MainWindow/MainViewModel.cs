...
namespace Students.ViewModel
{
    public class MainViewModel:BindableBase
    {
        ...
        public MainViewModel(Action<bool> closeAction)
        {
            ...
            studentListVM.SwitchControl += ChangeToStudentAfterAdd;
            ...
            studentInfoVM.AddStudentInList += AddStudentInList;
        ...
        private void ChangeToStudent(StudentInfoNode student)
        {
            ...
            studentInfoVM.Student = new StudentInfoNode(student);
        ...
        private void ChangeToStudentAfterAdd(StudentInfoNode student)
        {
            VisibleContent = _contentList[1];
        }
        public void AddStudentInList(StudentInfoNode student)
        {
            StudentsListView studentList = new StudentsListView();
            StudentsListViewModel studentListVM = studentList.GetDataContext();
            studentListVM.StudentList.Add(student);
        }
